package com.freetsinghua.tool.core.other.util;

import static com.freetsinghua.tool.core.other.util.ByteProcessorUtils.CARRIAGE_RETURN;
import static com.freetsinghua.tool.core.other.util.ByteProcessorUtils.HTAB;
import static com.freetsinghua.tool.core.other.util.ByteProcessorUtils.LINE_FEED;
import static com.freetsinghua.tool.core.other.util.ByteProcessorUtils.SPACE;
