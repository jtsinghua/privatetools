 ...
 * @date 2019/2/13
 */
public class EJsonProcessingException extends Exception {
    /**
     ...
     */
    public EJsonProcessingException() {
        super();
    }
     ...
     */
    public EJsonProcessingException(String message) {
        super(message);
    }

    /**
     * Constructs a new exception with the specified detail message and cause.  <p>Note that the detail message associated with
     ...
     * @since 1.4
     */
    public EJsonProcessingException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public EJsonProcessingException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected EJsonProcessingException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
