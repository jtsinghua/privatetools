...
public class ObjectPool {
    public static final class Builder {
         ...
         * pools created with this configuration instance.
         *
         * @param softMinEvictableIdleTimeMillis The new setting of {@code
         *     softMinEvictableIdleTimeMillis} for this configuration instance
         ...
         * pools created with this configuration instance.
         *
         * @param evictorShutdownTimeoutMillis The new setting of {@code
         *     evictorShutdownTimeoutMillis} for this configuration instance
         ...
         * pools created with this configuration instance.
         *
         * @param timeBetweenEvictionRunsMillis The new setting of {@code
         *     timeBetweenEvictionRunsMillis} for this configuration instance
        ...
        @SuppressWarnings("unchecked")
        public <T> GenericObjectPool build(BasePooledObjectFactory<T> objectFactory) {
