    ...
    private static ConcurrentTaskScheduler getScheduler() {
        try {
            ThreadFactory threadFactory =
                    new ThreadFactoryBuilder().setNameFormat("scheduled-%d").setDaemon(false).build();
            ScheduledThreadPoolExecutor scheduledThreadPoolExecutor =
                    new ScheduledThreadPoolExecutor(
                            coreSize, threadFactory, new ThreadPoolExecutor.CallerRunsPolicy());
        ...
        try {
            ...
            String coreSizeStr =
                    properties.getProperty(
                            "threadpool.corePoolSize", String.valueOf(CommonConstant.AVAILABLE_PROCESSORS));
