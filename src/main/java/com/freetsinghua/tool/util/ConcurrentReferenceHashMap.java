...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public ConcurrentReferenceHashMap(
        ...
        Segment[] segments = (Segment[]) ArrayUtils.newArray(Segment.class, size);
     ...
     *                                       this map
     * @throws ClassCastException            if the key or value is of an inappropriate type for
     *                                       this map (<a href="../Collection.html#optional-restrictions">optional</a>)
     * @throws NullPointerException          if the specified key or value is null, and this map
     *                                       does not permit null keys or values (<a
    ...
    public boolean remove(Object key, Object value) {
        Boolean result = doTask(key, new Task<Boolean>(TaskOption.RESTRUCTURE_AFTER, TaskOption.SKIP_IF_EMPTY) {
            /**
             * Convenience method that can be used for tasks that do not need
             * access to {@link Entries}.
             *
             * @param ref   the found reference (or {@code null})
             * @param entry the found entry (or {@code null})
             * @return the result of the task
     ...
     * @throws ClassCastException            {@inheritDoc}
     * @throws NullPointerException          {@inheritDoc}
     * @implSpec This implementation iterates over <tt>entrySet()</tt> searching for an entry with
     * the specified key.  If such an entry is found, its value is obtained with its
     * <tt>getValue</tt> operation, the entry is removed from the collection (and the backing map)
     * with the iterator's
     * <tt>remove</tt> operation, and the saved value is returned.  If the
     * iteration terminates without finding such an entry, <tt>null</tt> is returned.  Note that
     * this implementation requires linear time in the size of the map; many implementations will
     * override this method.
     *
     * <p>Note that this implementation throws an
     * <tt>UnsupportedOperationException</tt> if the <tt>entrySet</tt>
     * iterator does not support the <tt>remove</tt> method and this map contains a mapping for the
     * specified key.
     */
    @Override
     ...
     * @throws UnsupportedOperationException if the {@code put} operation is not supported by this
     *                                       map
     * @throws ClassCastException            if the class of a specified key or value prevents it
     *                                       from being stored in this map
     * @throws NullPointerException          if a specified key or value is null, and this map does
    ...
    private abstract class Task<T> {
        ...
        /**
         * Convenience method that can be used for tasks that do not need access to {@link
         * Entries}.
         *
         * @param ref   the found reference (or {@code null})
         * @param entry the found entry (or {@code null})
